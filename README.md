...
A third-party PyTorch train/eval pipeline reimplementation of [One-step Latent-free Image Generation with Pixel Mean Flows (pixel Mean Flows / pMF)](https://arxiv.org/abs/2505.13447), faithfully ported from the [official JAX implementation](https://github.com/Lyy-iiis/pMF.git).
